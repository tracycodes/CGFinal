...
namespace CGFramework
{
	namespace Keyboard
	{
		enum KeyboardButtons	//LONG CHARACTER SET! : This maps over the win32 character (ascii) set
		{
			//Number Row
			NUM0 = 0x30,
			NUM1 = 0x31,
	...
	public:
		...
		bool IsPressed(Keyboard::KeyboardButtons key) const
		{
			return mKeyPressed[key];
		}
		bool IsLocked(Keyboard::KeyboardButtons key) const
		{
			return mKeyLocked[key];
		}
		void Lock(Keyboard::KeyboardButtons key)
		{
			mKeyLocked[key] = true;
		}
		void Reset()
